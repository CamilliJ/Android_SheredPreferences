...
class MainActivity2 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var txt01 = findViewById<TextView>(R.id.tvNome)
        var txt02 = findViewById<TextView>(R.id.tvCpf)
        var txt03 = findViewById<TextView>(R.id.tvEmail)

        var btnAdd = findViewById<Button>(R.id.btnAdd)
        var btnLoad = findViewById<Button>(R.id.btnLoad)
        var txtNome = findViewById<EditText>(R.id.etNome)
        var txtCPF = findViewById<EditText>(R.id.etCpf)
        var txtEmail = findViewById<EditText>(R.id.etEmail)
